        ...
        private void btnEnter_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    emplopyee = employeelist.First();

                    UserStatic.EmployeeID = emplopyee.ID;
                    UserStatic.UserNo =emplopyee.UserNo;
                    UserStatic.isAdmin = Convert.ToBoolean(emplopyee.isAdmin);
